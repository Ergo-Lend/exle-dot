...
class SingleLenderInitiationPaymentBox(
  val value: Long,
  ...
  def this(
    inputBoxes: mutable.Buffer[InputBox],
...
class SingleLenderFundLendPaymentBox(
  val value: Long,
...
class SingleLenderFundRepaymentPaymentBox(
  val value: Long,
  val singleAddressRegister: SingleAddressRegister
) extends PaymentBox {
  def this(
    inputBoxes: mutable.Buffer[InputBox],
