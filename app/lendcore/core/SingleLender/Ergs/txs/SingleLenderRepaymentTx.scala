...
import lendcore.components.errors.proveException
import lendcore.core.SingleLender.Ergs.boxes.registers.SingleAddressRegister
import lendcore.core.SingleLender.Ergs.boxes.{LendServiceBox, PaymentBox, SingleLenderFundRepaymentPaymentBox, SingleLenderRepaymentBox}
 ...
 *
 * Tx takes in input lendcore.components.boxes, and uses the info on the input lendcore.components.boxes to
 * create respective output lendcore.components.boxes
 * @param repaymentBox
 */
