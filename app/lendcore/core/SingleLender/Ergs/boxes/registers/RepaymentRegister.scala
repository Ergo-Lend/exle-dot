...
import lendcore.components.boxes.registers.RegisterTypes.CollByteRegister
import lendcore.core.SingleLender.Ergs.boxes.registers.RepaymentDetailsRegister.calculateInterestRate
