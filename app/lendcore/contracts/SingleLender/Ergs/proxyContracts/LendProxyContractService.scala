package lendcore.contracts.SingleLender.Ergs.proxyContracts

import config.Configs
import lendcore.components.ergo.Client
import lendcore.contracts.SingleLender.Ergs.proxyContracts.proxyContracts.{createSingleLenderLendBoxProxyScript, fundSingleLenderLendBoxProxyScript, repaySingleLenderLoanProxyScript}
