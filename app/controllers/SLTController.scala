...
class SLTController @Inject() (
    val client: Client,
    val explorer: LendBoxExplorer,
    val lendProxyAddress: LendProxyAddress,
    ...
    // ===== SLT Mock Create and Fund Methods ===== //
